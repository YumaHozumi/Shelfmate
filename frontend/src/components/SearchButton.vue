...
const rules = ref([
  (value: string) => !value.includes('-') || "ハイフンなしで入力してください",
  (value: string) => !/[０-９]/.test(value) || "半角数字で入力してください",
  (value: string) => validateISBN(value) || "無効なISBNです",
])
    ...
    <v-dialog v-model="dialog" fullscreen hide-overlay transition="dialog-bottom-transition">
        ...
        <v-card>
            ...
            <v-card-text>
                ...
                <SearchBar label="ISBN(13桁または10桁) ※ハイフンなし" @search="searchClick" :rules="rules"></SearchBar>
